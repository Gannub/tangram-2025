...
def assign_tangram_label(contour, approx, _color):
    vertices = len(approx)
...
def main():
    ...
    while True:
        ...
        for color_name, ranges in COLOR_RANGES.items():
            ...
            color_mask = cv2.bitwise_and(color_mask, color_mask, mask=inverse_hand_mask)
            ...
            for cnt in contours:
                ...
                tangram_label = assign_tangram_label(cnt, approx, _color=color_name)
